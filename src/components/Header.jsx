...
function Header() {
  const {favorites, onOpenCart, cartItems} = useContext(AppContext);
    ...
    return (
      <header className="header">
        ...
        <ul className="header__right">
          <li className="header__link" onClick={onOpenCart}>
            <svg className="header__svg-scale" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="header__cart-value">{cartItems.length > 0 && totalPrice}</span>
          </li>
            <li>
            <Link to="/favorites" className="header__link">
              <svg className="header__svg-scale" width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="header__liked">{favorites.length > 0 && favorites.length}</span>
              <span className="visually-hidden">Избранное</span>
            </Link>
            </li>
            <li>
            <Link to="/orders" className="header__link">
            <svg className="header__svg-scale" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="visually-hidden">Заказы.</span>
            </Link>
            </li>
        </ul>
      </header>
